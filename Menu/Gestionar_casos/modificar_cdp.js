document.addEventListener('DOMContentLoaded', () => {
    ...
    const textarea = document.getElementById('textarea_modificar');
    ...
    const botonAutomatizar = document.getElementById('boton_automatizar');
    if (botonAutomatizar) {
    botonAutomatizar.addEventListener('click', () => {
        alert('Automatizar: función disponible próximamente');
        });
    }
